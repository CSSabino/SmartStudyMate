...
<div id="passwordForm">
    ...
    <form action="scelta-password" method="post">
        ...
        <p>La password deve essere lunga almeno 8 caratteri. Deve contenere almeno una lettera maiuscola, una minuscola, un numero ed un carattere speciale (._%+-).</p>
        <%
            String matching = (String) session.getAttribute("matching");
            if(matching != null && matching.equalsIgnoreCase("false")){
        %>
        <p style="color: red">La password non rispetta il formato richiesto. Riprova con una nuova password.</p>
        <%
            }
        %>
